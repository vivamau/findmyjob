...
- Intitiallyt, get strict to this folder structure:
	- backend
		- data
		- db
		- middleware
...
### Schema & Migrations
- **Primary Schema Definition**: The complete database schema is maintained in `backend/migrations/001_initial.sql`.
- **Migration Strategy**: 
